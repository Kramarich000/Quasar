...
async function getSuggestions(query) {
    ...
    try {
        ...
        // Combine and deduplicate suggestions
        const allSuggestions = [...new Set([...googleSuggestions, ...duckDuckGoSuggestions])];
...
addSiteForm.addEventListener('submit', function(e) {
    ...
    // Create icon (using a generic globe icon)
    ...
    // Insert before the "Add site" button
    ...
    try {
        ...
        const isDuplicate = customSites.some(site => 
            site.url === siteUrl || site.name === siteName
        );
...
// Load custom sites on page load
window.addEventListener('load', function() {
    try {
        ...
        // Clear existing custom links (except the "Add site" button)
        const existingLinks = quickLinks.querySelectorAll('.quick-link:not(#addCustomSite)');
